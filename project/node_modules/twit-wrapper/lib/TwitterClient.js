...
class TwitterClient {
  constructor(consumerAPIKey, consumerAPISecretKey, accessToken, accessTokenSecret, timeout = 60000, strictSSL = true) {
    this.twit = new Twit({
  ...
  postTweet(msg) {
    return new Promise((resolve, reject) => {
      ...
      this.twit.post(url, params).then(res => {
  ...
  getTweets(keyword, fromDate, lang = 'en', maxResults = 100) {
    return new Promise((resolve, reject) => {
      ...
      this.twit.get(url, params).then(res => {
